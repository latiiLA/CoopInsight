...
var appErrors = []struct {
	...
	{common.ErrADUnavailable, http.StatusServiceUnavailable},
	...
	{common.ErrAccountPendingApproval, http.StatusForbidden},
	{common.ErrAccountRequestNotFound, http.StatusNotFound},
	{common.ErrAccountRequestAlreadyHandled, http.StatusConflict},
	{common.ErrFailedToFetchAccountRequests, http.StatusInternalServerError},
	{common.ErrFailedToCreateAccountRequest, http.StatusInternalServerError},
	{common.ErrFailedToUpdateAccountRequest, http.StatusInternalServerError},
	{common.ErrRoleNameAlreadyExists, http.StatusConflict},
	{common.ErrRoleNameNotAllowed, http.StatusBadRequest},
	{common.ErrRoleInUse, http.StatusConflict},
	...
	{common.ErrFailedToDeleteUser, http.StatusInternalServerError},
	{common.ErrCannotDeleteSelf, http.StatusBadRequest},
	{common.ErrCannotSuspendSelf, http.StatusBadRequest},
	{common.ErrUserAlreadySuspended, http.StatusConflict},
	{common.ErrUserNotSuspended, http.StatusConflict},
	{common.ErrCannotSuspendUser, http.StatusBadRequest},
	{common.ErrUserHasActivity, http.StatusConflict},
	...
	{common.ErrFailedToDeleteRole, http.StatusInternalServerError},
	...
	{common.ErrInvalidSuccessFlow, http.StatusBadRequest},
	{common.ErrInvalidSuccessOutcome, http.StatusBadRequest},
	{common.ErrInvalidSuccessGranularity, http.StatusBadRequest},
	{common.ErrTrendRangeTooLarge, http.StatusBadRequest},
