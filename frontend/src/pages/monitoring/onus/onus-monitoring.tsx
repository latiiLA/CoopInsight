...
function monitoringSocketUrl(token: string) {
  ...
  if (apiBase.startsWith("http://") || apiBase.startsWith("https://")) {
    const url = new URL(`${apiBase}/monitoring/onus/ws`);
  ...
  return `${protocol}//${window.location.host}${apiBase}/monitoring/onus/ws?token=${encodeURIComponent(token)}`;
}
  ...
  return (
    <div className="container mx-auto">
        ...
        <div className="flex items-center gap-2">
          <div className="relative w-52">
            ...
            <Input
              ...
              placeholder="Search terminal, STAN..."
      ...
      <div className="mt-1 overflow-hidden rounded-lg border">
        <div className="grid grid-cols-[7rem_7rem_1fr_7rem_6rem_7rem] gap-3 border-b bg-muted/40 px-4 py-1.5 text-xs font-medium text-muted-foreground">
          <span>Time</span>
          <span>Terminal</span>
        ...
        <div className="max-h-[calc(100svh-7rem)] overflow-auto">
          {events.length === 0 ? (
            <div className="px-4 py-6 text-center text-sm text-muted-foreground">
              Waiting for live on-us transactions...
            </div>
            ...
            filteredEvents.map((event) => (
              <div
                ...
                className="grid grid-cols-[7rem_7rem_1fr_7rem_6rem_7rem] gap-3 border-b px-4 py-1.5 text-sm last:border-b-0"
              >
